...
func MapToDomainCreateTour(row db.CreateTourRow) *domain.Tour {
	tour := &domain.Tour{
		ID:                 PgUUIDToUUID(row.ID),
		Slug:               row.Slug,
		Title:              row.Title,
...
func MapToDomainGetTourByID(row db.GetTourByIDRow) *domain.Tour {
	tour := &domain.Tour{
		ID:                 PgUUIDToUUID(row.ID),
		Slug:               row.Slug,
		Title:              row.Title,
...
func MapToDomainGetTourBySlug(row db.GetTourBySlugRow) *domain.Tour {
	tour := &domain.Tour{
		ID:                 PgUUIDToUUID(row.ID),
		Slug:               row.Slug,
		Title:              row.Title,
...
func MapToDomainUpdateTourByID(row db.UpdateTourByIDRow) *domain.Tour {
	tour := &domain.Tour{
		ID:                 PgUUIDToUUID(row.ID),
		Slug:               row.Slug,
		Title:              row.Title,
...
func MapToDomainTours(rows []db.GetToursRow) []domain.Tour {
...
func MapToDomainSimilarTours(rows []db.GetSimilarToursByTourIDRow) []domain.Tour {
	tours := make([]domain.Tour, 0, len(rows))
	for _, row := range rows {
		tour := domain.Tour{
			ID:                 PgUUIDToUUID(row.ID),
