...
export default [
...

  {
    ...
    rules: {
      ...
      'no-restricted-imports': ['error', {patterns: ['^\\.{1,2}/']}],
      ...
      '@typescript-eslint/member-ordering': ['error', {
        default: ['public-field', 'protected-field', 'private-field', 'constructor', 'public-method', 'protected-method', 'private-method'],
      }],
  ...
  {
    files: ['src/seeds/**/*.ts', 'src/scripts/**/*.ts'],
    rules: {
      'no-console': 'off',
